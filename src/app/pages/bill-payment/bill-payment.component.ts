...
export class BillPaymentComponent implements OnInit {
  ...
  onSubmit() {
    if (this.topUpForm.valid) {
      ...
      this.topUpForm.controls["expDate"].setValue(
      ...
      this.noebsApiSerivce.billPaymentService(this.topUpForm.value).subscribe(
        response => {
          ...
          this.transLogger.add("BILL_PAYMENT", response.ebs_response)
        ...
        err => {
          ...
          this.transLogger.add('BILL_PAYMENT', err.error.details)
          console.log(err);
